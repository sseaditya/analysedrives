            ...
            <main className="container mx-auto px-4 py-8 flex-1 space-y-8">
                <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-muted-foreground mt-1">Explore public drives from the community.</p>
                    </div>

                    {/* Toggle / Nav (Optional, mostly covered by Header) */}
                    <div className="flex bg-muted/50 p-1 rounded-lg">
                        <button onClick={() => navigate('/dashboard')} className="px-4 py-1.5 rounded-md text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">
                            My Activities
                        </button>
                        <button className="px-4 py-1.5 rounded-md text-sm font-medium bg-background text-foreground shadow-sm transition-colors">
                            Community Feed
                        </button>
                    </div>
                </div>
