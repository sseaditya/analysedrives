    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col font-sans">
        ...
        <div>
          {!user ? (
            <button
              ...
              className="bg-card text-card-foreground hover:bg-muted border border-border px-5 py-2 rounded-full text-sm font-semibold transition-all shadow-sm"
            >
              Log In
            </button>
          ) : (
      ...
      <section className="bg-card py-16 px-4 border-t border-border">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-sm font-bold uppercase tracking-widest text-muted-foreground mb-12">Precision Tools for Enthusiasts</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 rounded-xl border border-border hover:border-[#CC785C]/50 transition-colors bg-background/50">
              ...
              <h3 className="font-bold text-foreground mb-2">Distribution Analysis</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">Visualize exactly how much time you spend in specific speed zones and gradients.</p>
            </div>
            <div className="p-6 rounded-xl border border-border hover:border-[#CC785C]/50 transition-colors bg-background/50">
            ...
            <div className="p-6 rounded-xl border border-border hover:border-[#CC785C]/50 transition-colors bg-background/50">
              ...
              <h3 className="font-bold text-foreground mb-2">Interactive Timeline</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">Zoom into any second of your activity to see correlated speed, elevation, and location data.</p>
            </div>
          </div>
        </div>
      </section>
